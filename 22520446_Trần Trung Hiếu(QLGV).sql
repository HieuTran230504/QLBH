...
--Cau 10-I:
--INSERT VA UPDATE KHOA
CREATE TRIGGER IN_UDT_KHOA ON KHOA
FOR INSERT, UPDATE
AS
BEGIN
	IF NOT EXISTS(
		...
		WHERE I.TRGKHOA = GV.MAGV AND GV.HOCVI IN ('TS', 'PTS'))
	BEGIN
		PRINT 'ERRO: TRUONG KHOA CUA KHOA PHAI LA GIAO VIEN CUA KHOA DO'
		ROLLBACK TRAN
	END
END
